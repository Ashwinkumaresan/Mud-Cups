...
export const AuthModal: React.FC<AuthModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-fadeIn">
      <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl relative border border-gray-100 flex flex-col max-h-[92vh] overflow-y-auto">
            ...
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="bg-gray-50 p-6 rounded-2xl border border-[#b7122a]/20 flex flex-col items-center text-center relative overflow-hidden">
                <div className="bg-white p-3 rounded-2xl shadow-md border border-[#b7122a]/10 mb-3">
                  {qrDataUrl ? (
                    ...
                    <div className="w-48 h-48 bg-gray-100 rounded-lg flex items-center justify-center text-xs text-gray-400">
                      Generating QR Code...
                    </div>
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 bg-gray-50 p-2.5 rounded-xl border border-gray-200">
                    ...
                    <button
                      ...
                      className="bg-white hover:bg-gray-100 text-gray-700 px-2.5 py-1 rounded-lg text-xs font-bold border border-gray-200 transition-colors flex items-center gap-1 cursor-pointer"
                    >
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <button
                  ...
                  className="bg-gray-900 hover:bg-black text-white py-2.5 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer shadow-xs"
                >
                ...
                <button
                  ...
                  className="bg-gray-100 hover:bg-gray-200 text-gray-800 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                >
          ...
          {activeTab === 'join' && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="bg-gray-50 p-4 rounded-2xl border border-gray-200 space-y-3">
                ...
                {scannerStatus && (
                  <p className="text-[11px] text-gray-600 bg-white p-2 rounded-lg border border-gray-200 text-center">
                    {scannerStatus}
                  </p>
                )}
                ...
                <div className="flex gap-2">
                  {!isScanning ? (
                    ...
                    <button
                      onClick={stopCamera}
                      className="flex-1 bg-gray-800 hover:bg-gray-900 text-white py-2 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                    >

    ...
    <footer className="bg-white border-t border-gray-200 w-full py-12 px-4 md:px-6 mt-16">
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
        ...
        <div className="flex flex-col gap-4 col-span-2 md:col-span-1">
          <a href="#" className="text-xl font-extrabold text-[#b7122a] flex items-center gap-2">
        ...
        <div className="flex flex-col gap-3">
          ...
          <a href="#" className="text-xs text-[#6B6B6B] hover:underline hover:text-[#b7122a] transition-colors">
            About Us
          </a>
          <a href="#" className="text-xs text-[#6B6B6B] hover:underline hover:text-[#b7122a] transition-colors">
            Partner with us
      ...
      <div className="max-w-7xl mx-auto pt-6 border-t border-[#e4bebc]/50 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="w-8 h-8 rounded-full bg-white border border-[#ECECEC] flex items-center justify-center text-[#1C1C1C] hover:text-[#b7122a] hover:border-[#b7122a] transition-colors cursor-pointer shadow-xs"
          >
